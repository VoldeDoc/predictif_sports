        ...
        {loading ? (
          ...
          <>
            <Routes>
              ...
              <Route path="/fantasy-league" element={<FantasyLeagueDashPage />} />
              <Route path="/auth/change-passwordmail" element={<Change_PasswordEmail />} />
              <Route path="/auth/change-password" element={<Change_Password />} />
              <Route path="/auth/otp-changepwd" element={<OtpChangePwdVerification />} />
              ...
              <Route path="/user/strategies" element={<StrategyPage/>} />
              <Route path="/fixtures" element={<FixturesT />} />
              <Route path="/forum" element={<ForumT />} />
              <Route path="/forum/messages/:id" element={<Message_Box />} />
              ...
              {/* Unprotected Routes */}
              <Route path="/user/user-group/:id" element={<User_group />} />
              <Route path="/user/settings/:id" element={<GroupSettingsPage />} />
              <Route path="/user/all-groups" element={<ALl_Groups />} />
              ...
              <Route path="/user/strategy/:strategy_id" element={<GeneralStrategyPage />} />
              <Route path="/user/strategies" element={<StrategyPage />} />
              <Route path="/user/create-strategy/:strategy_id" element={<CreateStrategyPage />} />
              <Route path="/user/update-strategy/:strategy_id" element={<UpdateStrategyPage />} />
              <Route path="/user/preset/" element={<PresetRulesPage />} />
              <Route path="/match-schedule" element={<MatchSchedulePage />} />
              <Route path="/match-schedule/:id" element={<MatchDetails />} />
              <Route path="/user/import-rules" element={<ImportRulesPage />} />

              {/* UI & Subscription Routes */}
              <Route path="/user/subscribe-plan/:id" element={<SubscriptionPlan />} />
              <Route path="/user/follow-team/:id" element={<FollowTeam />} />
              <Route path="/user/follow-player/:id" element={<FollowPlayers />} />
              <Route path="/user/checkout/:id" element={<CheckoutPage />} />
              <Route path="/user/payment-success" element={<SuccessPage />} />
              <Route path="/user/payment-success/paystack" element={<PaystackSuccessPage />} />
              <Route path="/user/player/:player_id" element={<PlayerDetails />} />
              <Route path="/user/team/:team_id" element={<TeamDetails />} />
