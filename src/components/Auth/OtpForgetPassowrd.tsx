...
const OtpForgetPwdVerification = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      dispatch(setOtpMail(otpMail));
      router("/auth/forget-password", { state: { email: otpMail, otp: enteredOtp } });
...
export default OtpForgetPwdVerification;