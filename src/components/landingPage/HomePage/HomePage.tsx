                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                            <div className="flex space-x-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-700 pb-3">The AI scans historical performance, player statistics, team dynamics, injury reports, and weather conditions to identify trends and patterns.
                                    </p>
                            ...
                            <div className="flex space-x-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-700 pb-3">Using machine learning algorithms, the AI generates predictive models that forecast outcomes based on historical data and current variables.
                                    </p>
                                    <p className="text-gray-700">
                            ...
                            <div className="flex space-x-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-700 pb-3">Bettors receive personalized reports that highlight key metrics, recommended bets, and potential value opportunities based on their preferences and betting history.
                                    </p>
                                    <p className="text-gray-700">
                            ...
                            <div className="flex space-x-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-700 pb-3">The feature assesses risk levels associated with different betting options, allowing users to make informed choices about where to place their bets.
                                    </p>
                                    <p className="text-gray-700">
                            ...
                            <div className="flex space-x-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-700 pb-3">he AI curates insights from expert analysts, combining statistical data with expert opinions to provide a well-rounded view of upcoming games and events.
                                    </p>
                                    <p className="text-gray-700">
