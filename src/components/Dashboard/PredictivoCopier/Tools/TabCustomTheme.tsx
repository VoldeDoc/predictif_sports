      ...
      tabitem: {
        ...
        variant: {
          default: {
            base: "rounded-t-lg",
            active: {
              on: "bg-blue-100 text-cyan-600 dark:bg-gray-800 dark:text-cyan-500",
          ...
          pills: {
            base: "",
            active: {
              on: "rounded-lg bg-blue-800 text-white",
              off: "rounded-lg hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-800 dark:hover:text-white bg-white"
            }
          },
          fullWidth: {
