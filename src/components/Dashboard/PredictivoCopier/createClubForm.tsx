...
export default function CreateClubForm({ onSubmit }: CreateClubFormProps) {
  ...
  const addTeamSelection = () => {
    ...
    if (teamSelections.length >= 1) {
      alert("You can select only 1 team.");
      return;
    }

    setTeamSelections([...teamSelections, teamSelection]);
    setTeamSelection({ country: "", countryId: "", league: "", leagueId: "", team: "", teamId: "" });
    onSubmit(teamSelection.teamId); // Call the onSubmit prop with the selected team ID
  };
  ...
  return (
    <div className="max-w-5xl mx-auto p-8 bg-white  rounded-lg flex flex-col md:flex-row ">
      ...
      <div className="md:w-1/3 mt-8 md:mt-0">
        <h2 className="text-md font-semibold mb-4">Selected Team</h2>
