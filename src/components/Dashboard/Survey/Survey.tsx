...
export default function Survey() {
  ...
  const schema = yup.object().shape({
    ...
    // sport_bet: yup.array().of(yup.string()).required("Field is required"),
    // bet_type_prefer: yup.array().of(yup.string()).required("Field is required"),
    // influences_bet: yup.array().of(yup.string()).required(" required"),
    ...
    // platform_bet: yup.array().of(yup.string()).required("Field is required"),
    // motivates_bet: yup.array().of(yup.string()).required("Field is required"),
    negative_consequences_bet: yup.string().required(" required"),
    // placing_strategies_bet: yup.array().of(yup.string()).required(" required"),
    future_plan_bet: yup.string().required(" required"),
    // changes_see_sport: yup.array().of(yup.string()).required(" required"),
    ...
    comments_sport_bet: yup.string().required(" required"),
  });
